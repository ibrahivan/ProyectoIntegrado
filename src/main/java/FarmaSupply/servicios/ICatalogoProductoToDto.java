 ...
 * una entidad CatalogoProducto (DAO) a CatalogoProductoDTO
 */
public interface ICatalogoProductoToDto {

	/**
	 * Método que convierte campo a campo un objeto entidad CatalogoProducto a
	 * catalogoProductoDTO
	 * 
	...
	/**
	 * Metodo que convierte todos los objetos entidad catalogoProducto DAO a una
	 * lista CatalogoProductoDTO
	 * 
