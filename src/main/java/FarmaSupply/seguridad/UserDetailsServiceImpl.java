 ...
 * es necesario una clase en el proyecto que implemente la interfaz
 * UserDetailsService y sobre escribir el método loadUserByUsername de la
 * misma.
 */
...
public class UserDetailsServiceImpl implements UserDetailsService {
	 ...
	 * usuario. Buscando un usuario por su nombre de usuario y después devolviendo
